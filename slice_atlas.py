...
def fuse_labels(t1: np.ndarray, id_: str, acq: Path, nib_obj) -> tuple[ndarray, ndarray]:
...
def main(args: argparse.Namespace):
    ...
    if dest_path.exists() :
        os.rename(dest_path,f"{dest_path}_tmp5")
        # return True
